        ...
        <tr>
          ...
          <td style="padding-left:130px;"><table width="525" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="75" ><div align="center"> <span class="STYLE1" > <a href="javascript:adClick('left.asp?id=', 'tab.asp');"  style=" backgroundColor:#a8a5a5" id="a1" onclick="change(this.id)" >系统首页</a> </span> </div></td>
                <td width="4"><img src="images/default_13.gif" width="4" height="23" /></td>
                <td width="75"><div align="center"> <span class="STYLE1"> <a href="javascript:adClick('left.asp?id=zc', 'sb/news_list.asp');" id="a2"  onclick="change(this.id)">资产管理</a> </span> </div></td>
                <td width="4"><img src="images/default_13.gif" width="4" height="23" /></td>
                <td width="75"><div align="center"> <span class="STYLE1"> <a href="javascript:adClick('left.asp?id=xx', 'user/admin_yuangong.asp');"  id="a3"  onclick="change(this.id)">信息管理</a> </span> </div></td>
                <td width="4"><img src="images/default_13.gif" width="4" height="23" /></td>
                <td width="75"><div align="center"> <span class="STYLE1"> <a href="javascript:adClick('left.asp?id=xt', 'admin/user_log.asp');"  id="a4" onclick="change(this.id)">系统管理</a> </span> </div></td>
                <td width="4"><img src="images/default_13.gif" width="4" height="23" /></td>
                <td width="75"><div align="center"> <span class="STYLE1"> <a href="javascript:adClick('left.asp?id=gj', 'tools/calculator/index.html');"  id="a5" onclick="change(this.id)">小工具</a> </span> </div></td>
                <td width="4"><img src="images/default_13.gif" width="4" height="23" /></td>
                <td width="75"><div align="center"> <span class="STYLE1"> <a href="login.asp?action=out"  id="a6" onclick="change(this.id)" target="_parent">退出系统</a> </span> </div></td>
                <td width="4"><img src="images/default_13.gif" width="4" height="23" /></td>
              </tr>
            </table></td>
        </tr>
