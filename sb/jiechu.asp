...
<%
if Instr(session("juese"),"|104,")=0 then %>
...
for(i=0;i<Pcount;i++){
	if(document.form1.gss.value===subCat1[i][0]){document.form1.ssbm.options[document.form1.ssbm.length]=new Option(subCat1[i][1],subCat1[i][0],true,true);}else{document.form1.ssbm.options[document.form1.ssbm.length]=new Option(subCat1[i][1],subCat1[i][0]);}
}}
</script>
    <%
...
document.form1.syr.options[0]=new Option("==选择借出人==","");
for(i=0;i<Ccount;i++){
...
<tr class=classtop1>
<td  height="25" colspan="4" align="center"><strong>资 产 借 出
  <input type="hidden" name="gss" value="<%=rsu("ssbm")%>">
</strong></td>
</tr>
...
<tr><td height="25" align="center" class="classtd"><div align="left">&nbsp;&nbsp;<strong>资产类别：</strong></div></td>
    <td height="25" align="center" class="classtd"><div align="left">
    ...
    <td height="25" align="center" class="classtd"><div align="left">
      <input name="zilei" class="form" id="zilei" value="<%=rsu("zilei")%>" size="20" maxlength ="50" disabled style="WIDTH: 180px"/>
    </div></td></tr>
<tr>
...
<tr>
  <td height="25" align="center" class="classtd"><div align="left">&nbsp;<font color="#ff0033">*</font><strong> 使 用 人：</strong></div></td>
  <td height="25" align="center" class="classtd"><div align="left">
    <input name="syz" class="form" maxlength ="50" style="WIDTH:100px"/>
    <select name="syr" id="syr" class="form" onChange="syz.value=this.value">
      <option value="">==选择借出人==</option>
    </select>
    <font color="red">请输入或选择借出人</font></div></td>
  <td height="25" align="center" class="classtd"><div align="left"><font color="#ff0033">&nbsp;*</font><strong> 所属部门：</strong></div></td>
  <td height="25" align="center" class="classtd"><div align="left"><span class="font">
    <select class="form" name="department" id="department" style="WIDTH: 180px">
      <option value="">==选择部门==</option>
    </select>
  </span><font color="#F00">请重选公司后，再选择部门、使用人</font></div></td></tr>
<tr>
...
<tr>
  ...
  <tr>
    <td height="25" colspan="4" align="center" class="classtd"><input name="提交" type="submit" class="button" value=" 借出 " />&nbsp;
      <input name="reset" type="reset" onClick="javascript:history.back(-1);" class="button"  value=" 取消 " />
	  <input type="hidden" name="id" value="<%=request("id")%>" /></td></tr>
  </form>
</table>
</body>
</html>
