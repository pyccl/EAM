...
if Instr(session("juese"),"|107,")=0 then %>
  <!--#include file="../inc/quanxian.asp"-->
  <%
  response.end 
else
   session("ysyz")=rsu("syz")
   session("ydepartment")=rsu("department")
%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<title>公司资产管理系统-资产转移</title>
<link href="../css.css" rel="stylesheet" type="text/css">
<link href="../images/tab.css" rel="stylesheet" type="text/css">
</head>
<body>
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#6298E1" align="center" width="100%">
  <form name="form1" action="zhuan2.asp?page=<%=page%>&qx=<%=id%>" method="post">
    <tr class=classtop1>
      <td  height="25" colspan="4" align="center"><strong>资 产 转 移</strong></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="25" align="center" class="classtd"><div align="left">&nbsp;<font color="#ff0033">*</font><strong> 现使用人：</strong></div></td>
      <td height="25" align="center" class="classtd"><div align="left">
          <input name="xsyz" class="form" size="20" maxlength ="50"  style="WIDTH: 180px"/>
        </div></td>
      <td height="25" align="center" class="classtd"><div align="left"><font color="#ff0033">&nbsp;*</font><strong> 现属部门：</strong></div></td>
      <td height="25" align="center" class="classtd"><div align="left">
          <input name="xdepartment" value="<%=rsu("department")%>" class="form" size="20" style="WIDTH: 180px"/>
        </div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="25" colspan="4" align="center" class="classtd"><input name="提交" type="submit" class="button" value=" 转移 " />
        &nbsp;
